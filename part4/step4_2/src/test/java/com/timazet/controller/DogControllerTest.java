...
//    @Test
//    public void shouldReturnDogs() throws Exception {
//        mockMvc.perform(get(DOGS).accept(MediaType.APPLICATION_JSON_UTF8))
...
//        Dog dog = mockMvc.perform(get(DOGS)).jsonPath().getObject("[1]", Dog.class);
